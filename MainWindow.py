...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.tabWidget.setGeometry(QtCore.QRect(10, 0, 891, 601))
        ...
        self.plainTextEdit_manualEnter.setGeometry(QtCore.QRect(10, 50, 811, 41))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.plainTextEdit_manualEnter.setFont(font)
        self.plainTextEdit_manualEnter.setMouseTracking(True)
        self.plainTextEdit_manualEnter.setFrameShape(QtWidgets.QFrame.NoFrame)
        ...
        self.plainTextEdit_English.setGeometry(QtCore.QRect(10, 90, 811, 51))
        font = QtGui.QFont()
        font.setPointSize(12)
        ...
        self.plainTextEdit_English.setFrameShape(QtWidgets.QFrame.NoFrame)
        ...
        self.pushButton_Prev.setGeometry(QtCore.QRect(830, 10, 50, 24))
        self.pushButton_Prev.setFocusPolicy(QtCore.Qt.TabFocus)
        ...
        self.pushButton_Next.setGeometry(QtCore.QRect(830, 60, 50, 24))
        self.pushButton_Next.setAutoDefault(True)
        self.pushButton_Next.setObjectName("pushButton_Next")
        self.plainTextEdit_CN_line = QtWidgets.QPlainTextEdit(self.Practice)
        self.plainTextEdit_CN_line.setGeometry(QtCore.QRect(10, 10, 811, 32))
        font = QtGui.QFont()
        font.setPointSize(12)
        ...
        self.lineEdit_English_Line_Number.setGeometry(QtCore.QRect(830, 110, 50, 20))
        ...
        self.plainTextEdit_Chinese.setGeometry(QtCore.QRect(10, 150, 861, 421))
        font = QtGui.QFont()
        font.setPointSize(12)
        ...
        self.label.setGeometry(QtCore.QRect(700, 470, 141, 31))
        font = QtGui.QFont()
        font.setPointSize(12)
        font.setItalic(True)
        ...
        self.pushButton_Exit.setGeometry(QtCore.QRect(840, 610, 50, 21))
        ...
        self.pushButton_Refresh.setGeometry(QtCore.QRect(780, 610, 50, 21))
        self.pushButton_Refresh.setFocusPolicy(QtCore.Qt.NoFocus)
        self.pushButton_Refresh.setAutoDefault(True)
        ...
        MainWindow.setTabOrder(self.plainTextEdit_manualEnter, self.pushButton_Next)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(_translate("MainWindow", "To my love: Becky"))
